...
if __name__ == '__main__':
    ...
    torch.save(embedding, (f'{config["plot_embedding"]["output_name"]}/embedding.pth'))

    print(f'number of features: {embedding.shape[0]}')

    f, ax = plt.subplots(1,1,figsize=(20,20))
    for unique_category in unique_categories:
        ax.scatter(embedding[category_inds[unique_category], 0],
                   embedding[category_inds[unique_category], 1], s=1, label=unique_category)
